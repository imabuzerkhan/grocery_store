...
function BookingSection({ children, business }) {
  ...
  const saveBooking = () => {
    ...
    console.log(business, moment(date).format('DD-MMM-yyyy'), selectedTime, data.user.email, data.user.name);
    
    GlobalApi.createNewBooking(business, moment(date).format('DD-MMM-yyyy'), selectedTime, data.user.email, data.user.name)
      .then((resp) => {
        console.log(resp);
        if (resp) {
          setDate(new Date());
